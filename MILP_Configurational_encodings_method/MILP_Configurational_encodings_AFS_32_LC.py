...
def gubi(file, round_num, rot, k, s, Seq):
    ...
    point1 = "./" + "32bit_" +str(s)+ "_linear_" + str(round(round_num/2)) + "Round_"+str(k)+".txt"
...
def linear(blocksize2, k1, round_num, rot, s1, Seq):
    ...
    filename = "./" + "32bit_" + str(s1)+ "_linear_" + str(round(round_num/2))+ "Round_"+str(k1)+".lp"
...
def main():
    ...
    N=8                 #### Number of Rounds of the S-box
...
################## k is the set of rotation sequences.
    ...
    for Seq in range(0, len(s)):
        for rot in range(0, len(k)):
            ...
            ####################################Output Result File Storage Path
            point = "./"+"32bit_"+ str(s[Seq])+ "_linear_"+ str(round(round_num/2)) + "Round_" + str(k[rot])+ ".txt"
